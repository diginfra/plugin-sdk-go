...
DIGINFRA_LIBS_REVISION ?= 0b9ca98fee2453a16f4538db55dcfa34bc8f5aef
DIGINFRA_LIBS_REPO ?= diginfra/libs
PLUGINLIB_URL=https://raw.githubusercontent.com/${DIGINFRA_LIBS_REPO}/${DIGINFRA_LIBS_REVISION}/userspace/plugin
