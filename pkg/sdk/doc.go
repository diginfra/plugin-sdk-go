...
// (https://diginfra.org/docs/plugins/developers_guide/) which fully documents
// the API and provides best practices for writing plugins.
// The developer's guide includes a walkthrough
// (https://diginfra.org/docs/plugins/developers_guide/#example-go-plugin-dummy)
...
// (https://github.com/diginfra/plugin-sdk-go/tree/main/examples/extractor),
// with event sourcing capability,
// (https://github.com/diginfra/plugin-sdk-go/tree/main/examples/source),
// and with both
// (https://github.com/diginfra/plugin-sdk-go/tree/main/examples/full).
//
