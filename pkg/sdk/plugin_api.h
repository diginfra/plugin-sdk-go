...
// plugins loaded by the diginfra libraries to interact with the state
...
// Diginfrasecurity libs during a live event capture. The asynchronous events
...
typedef struct
{
	...
	struct
	{
		...
		// DIGINFRA ORGANIZATION, OTHERWISE IT WON'T PROPERLY COEXIST
		// WITH OTHER PLUGINS.
		//
		uint32_t (*get_id)();
	...
	struct
	{
		...
		// fields can be used in Diginfra rule conditions.
		// Required: yes
