...
#define DIGINFRA_PLUGIN_SDK_PUBLIC __declspec(dllexport)
#else
#define DIGINFRA_PLUGIN_SDK_PUBLIC
#endif
...
DIGINFRA_PLUGIN_SDK_PUBLIC int32_t plugin_extract_fields(ss_plugin_t *s,
							  const ss_plugin_event_input *evt,
